...
from .write_to_iamc_format import *
from .plot import *
from .input import *
...
def prepare_result_directory(result_name):
    ...
    result_dir = os.path.join('Output', '{}-{}'.format(result_name, now))
...
def run_scenario(input_files, Solver, timesteps, scenario, result_dir, dt,
                 ...
                 report_sites_name=None, upperbound=None, input_file_name=None):
    ...
    Args:
        ...
        - report_sites_name: (optional) dict of names for sites in
          report_tuples
        - upper bound is the maximum point for pareto front   
    ...
    report(
        prob,
        os.path.join(result_dir, '{}+{}.xlsx').format(sce, objective),
    ...
    result_figures(
        prob,
        os.path.join(result_dir, '{}_{}'.format(sce, objective)),
        timesteps,
